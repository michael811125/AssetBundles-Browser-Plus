...
namespace AssetBundleBrowser
{
    internal class AssetBundleTree : TreeView
    {
        ...
        protected override void RowGUI(RowGUIArgs args)
        {
            ...
            //Debug.Log(bundleItem.displayName);
            //{
            //    var size = args.rowRect.height;
            //    var right = args.rowRect.xMax;
            //    Rect toggleRect = new Rect(right - size, args.rowRect.yMin, size, size);
            //    if (GUI.Toggle(toggleRect, bundleItem.inBuild, string.Empty))
            //    {
            //        bundleItem.inBuild = true;
            //        if (bundleItem.hasChildren && bundleItem.inBuild)
            //        {
            //            foreach (var cb in bundleItem.children)
            //            {
            //                var cbItem = (cb as AssetBundleModel.BundleTreeItem);
            //                cbItem.inBuild = true;
            //            }
            //        }
            //    }
            //    else if (!GUI.Toggle(toggleRect, bundleItem.inBuild, string.Empty))
            //    {
            //        bundleItem.inBuild = false;
            //        if (bundleItem.hasChildren && !bundleItem.inBuild)
            //        {
            //            foreach (var cb in bundleItem.children)
            //            {
            //                var cbItem = (cb as AssetBundleModel.BundleTreeItem);
            //                cbItem.inBuild = false;
            //            }
            //        }
            //    }
            //}
